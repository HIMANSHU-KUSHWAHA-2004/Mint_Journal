...
import authservice_obj from '../../appwrite/auth.js'
...
function Signup() {
    ...
    const create = async(data) => {
        setError("")
        try {
            const session = await authservice_obj.createAccount(data)
            if (session) {
  ...
  return (
    <div className="px-5 py-14 sm:py-20">
            ...
            <div className="mb-7 flex justify-center"><Logo /></div>
                <p className="text-center text-xs font-bold uppercase tracking-[0.18em] text-amber-600">Start writing</p>
                <h2 className="mt-2 text-center font-serif text-4xl font-bold leading-tight text-slate-900">Create your account</h2>
